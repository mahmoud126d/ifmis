...
class AddStore extends StatefulWidget {
  ...
  AddStore(this.categoryID, this.description, {Key? key}) : super(key: key);
              ...
              child: ListView(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: textButton(
                            context,
                            otherProvider.getTexts('store file').toString(),
                            primaryColor,
                            white,
                  ...
                  Container(
                    ...
                    child: Text(
                      language ? settingModel.storeText.en : settingModel.storeText.ar,
